...
public class ReorderMyComponents : EditorWindow {
	...
	[MenuItem("Window/Custom Tools/Reorder Components")]
	private static void ShowWindow () {
		ReorderMyComponents windowHandle = (ReorderMyComponents)EditorWindow.GetWindow(typeof(ReorderMyComponents));
        GUIContent titleContent = new GUIContent("Reorder CPS");
